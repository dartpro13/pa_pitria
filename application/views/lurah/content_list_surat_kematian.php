            ...
            <table id="datatable" class="table table-striped table-bordered">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?= $row->status;?></td>
                  <td>
                    <a href="<?php echo base_url(). 'index.php/action/approve_surat_kematian/'.$row->id_surat; ?>" style="background-color:cornflowerblue;color:white;padding:5px;border-radius:10px;">Setujui</a>
                  </td>
                </tr>
                <?php
                }
