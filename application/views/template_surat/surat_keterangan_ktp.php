<html>
    ...
    <body>
        ...
        <p class="paragraf" justify>Berdasarkan Surat Keterangan dari Ketua RW :  06 Pecilon Timur</p>
            ...
            <p class="paragraf justify">Orang tersebut di atas benar Penduduk Desa kami, dan KTP yang aslinya masih dalam taraf penyesuaian.</p>
            <p class="paragraf justify">
            Sehubungan dengan hal tersebut diatas, sebagai Tanda Pengenal yang bersangkutan, maka diberikan Surat Keterangan KTP. Sementara dengan catatan sebagai berikut:
            </p>
            <section class="paragraf">
            <ol class="justify">
                <li>Apabila sewaktu-waktu KTP. Yang aslinya sudah keluar/selesai maka Surat Keterangan KTP. Sementara ini dianggap tidak berlaku lagi.</li>
                <li>Surat Keterangan KTP. Sementara ini hanya berlaku 1 (Satu) bulang terhitung sejak tanggal dikeluarkan.</li>
                <li>Surat Keterangan KTP. Sementara ini dapat dipergunakan sebagai pegangan yang bersangkutan dan dapat dipergunakan seperlunya.</li>
            </ol>
            </section>
        </section>
        <br>
        ...
        <br>
        <br>
        <section class="pengesahan f12 floatleft"><br>
