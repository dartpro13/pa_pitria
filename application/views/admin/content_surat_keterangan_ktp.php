          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Surat Layanan Penduduk / Keterangan KTP</h3>
              </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>e-Government <small>surat keterangan ktp</small></h2>
                  ...
                  <div class="x_content">
                    ...
                    if($sub=="Input"){
                        ...
                        $alamat="";
                        $ro="";
                        $url=base_url(). 'index.php/action/input_surat_keterangan_ktp';
                    }else if($sub=="Update")
                    {foreach ($surat as $row){
                        ...
                        $alamat=$row->alamat;
                      $ro="readonly";
                      $url=base_url(). 'index.php/action/update_surat_keterangan_ktp';
                     }}?>
