...
-->
    ...
    <a target="_SELF"href="<?=base_url()?>index.php/admin/doprint_laporan_penduduk/"><button type="button"class="btn btn-default btn-sm">Print Data Penduduk</button></a>
    <a target="_SELF"href="<?=base_url()?>index.php/admin/doprint_laporan_skp/"><button type="button"class="btn btn-default btn-sm">Print Data Surat Pindah</button></a>
    <a target="_SELF"href="<?=base_url()?>index.php/admin/doprint_laporan_skktp/"><button type="button"class="btn btn-default btn-sm">Print Data Surat Keterangan KTP</button></a>
    ...
    <div >
        ...
        <script>
            ...
            var myChart = new Chart(ctx, {
                type: 'bar',
                data: {
                    labels: ["Total Penduduk", "Laki-Laki", "Perempuan", "Total Surat Terbuat"],
                    datasets: [{
                            label: 'Overview',
